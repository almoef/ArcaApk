package com.example.arcaapk.Model;
...
public class Model {
  ...
  public Model(int ID, String cantidad, String códigoSAP, String descripciónBreve, String descripciónExtensa, String elemento, String imagen, String marca, String nombreTécnico, String númeroDeParte, String enlaceImagen) {
    this.ID = ID;
    Cantidad = cantidad;
    CódigoSAP = códigoSAP;
